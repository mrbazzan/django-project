...
Generated by 'djangocms' command using django CMS 4.1.1 and Django 5.1.2.
...
SECRET_KEY = 'django-insecure-r8ky-n2z_ws9!*frxkr$qk=fq$i3%s0oe_$g!62=#lda7073)r'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "rand", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
